...
import { StatusBar, Alert, View,Text,Image, TouchableOpacity } from 'react-native'
      ...
      <Container style={{ backgroundColor: '#1aae72'}}>
        ...
        >
            ...
            >
              ...
              <Text style={{fontSize:20,fontWeight:'bold'}}>Upgrade to Sabha Premium</Text>
            ...
            <Grid>
              <Row style={st.menuRow}>
                <Col style={st.menuCol}>
                  <ArchMenuButton icon="broadcast" onPress={() => this.goToMenu('Broadcasting')} />
                </Col>
                <Col style={st.menuCol}>
                  <ArchMenuButton icon="prayer" onPress={() => this.goToMenu('Prayer')} />
                </Col>
                <Col style={st.menuCol}>
                  <ArchMenuButton icon="qibla" onPress={() => this.goToMenu('Qibla')} />
                </Col>
              </Row>
              <Row style={st.menuRow}>
                <Col style={st.menuCol}>
                  <ArchMenuButton icon="masjid" onPress={() => this.goToMenu('Masjid')} />
                </Col>
                <Col style={st.menuCol}>
                  <ArchMenuButton icon="quran" onPress={() => this.goToMenu('Quran')} />
                </Col>
                <Col style={st.menuCol}>
                  <ArchMenuButton icon="events" onPress={() => this.goToMenu('Event')} />
                </Col>
              </Row>
            </Grid>
          </Content>
