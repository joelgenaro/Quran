      ...
      <StatusBar translucent backgroundColor="transparent" />
        ...
        >
            ...
            style={{
                ...
                <Text style={{color:'#fff',fontSize:20,marginLeft:h('2%')}}>{this.props.navigation.getParam('item')}</Text>
            </ImageBackground>
            <View
            style={{
                height:h('6%'),
            ...
            >
                <Text style={{color:'#000',fontSize:18,marginLeft:h('3%')}}>Select backgroundColor image</Text>
            </View>
            <View
            style={{
                height:h('34%'),
            ...
            >
                ...
                >
                    <TouchableOpacity
                    onPress={()=> {this.setState({image:img1})}}
                    style={{
                        height:h('17%'),
                        width:'31.7%',
                        // backgroundColor:'#aaf'
                    ...
                    <TouchableOpacity
                    onPress={()=> {this.setState({image:img2})}}
                    style={{
                        height:h('17%'),
                        width:'31.7%',
                        // backgroundColor:'#aaf',
                    ...
                    <TouchableOpacity
                    onPress={()=> {this.setState({image:img3})}}
                    style={{
                        height:h('17%'),
                        width:'31.7%',
                        // backgroundColor:'#aaf',
                ...
                >
                    <TouchableOpacity
                    onPress={()=> {this.setState({image:img4})}}
                    style={{
                        height:h('17%'),
                        width:'31.7%',
                        // backgroundColor:'#aaf'
                    ...
                    <TouchableOpacity
                    onPress={()=> {this.setState({image:img5})}}
                    style={{
                        height:h('17%'),
                        width:'31.7%',
                        // backgroundColor:'#aaf',
                    ...
                    <TouchableOpacity
                    onPress={()=> {this.setState({image:img6})}}
                    style={{
                        height:h('17%'),
                        width:'31.7%',
                        // backgroundColor:'#aaf',
