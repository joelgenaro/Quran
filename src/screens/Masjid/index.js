        ...
        return this.state.masjids.map((masjid, index) => {
          ...
          return (
            <ListItem avatar key={index} style={{ marginTop: 5, marginBottom: 10 }}>
              <Left>
                {ref != null &&
                  <Thumbnail square source={{ uri: `https://maps.googleapis.com/maps/api/place/photo?maxwidth=200&photoreference=${ref}&key=AIzaSyBuwq2z4lsEb6ve5s_PwSMJnuNlTgnU9bY` }} />
                }
                {ref === null &&
